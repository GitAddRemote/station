      ...
      await this.itemRepository
        ...
        .onConflict(
          `("uex_id") DO UPDATE SET
            ...
            date_modified     = NOW(),
            is_commodity      = COALESCE(EXCLUDED.is_commodity,      uex_item.is_commodity),
            is_buyable        = COALESCE(EXCLUDED.is_buyable,        uex_item.is_buyable),
            is_sellable       = COALESCE(EXCLUDED.is_sellable,       uex_item.is_sellable),
            uex_date_modified = COALESCE(EXCLUDED.uex_date_modified, uex_item.uex_date_modified),
            id_company        = COALESCE(EXCLUDED.id_company,        uex_item.id_company),
            section           = COALESCE(EXCLUDED.section,           uex_item.section),
            category          = COALESCE(EXCLUDED.category,          uex_item.category),
            company_name      = COALESCE(EXCLUDED.company_name,      uex_item.company_name),
            size              = COALESCE(EXCLUDED.size,               uex_item.size),
            star_citizen_uuid = COALESCE(EXCLUDED.star_citizen_uuid,  uex_item.star_citizen_uuid),
            weight_scu        = COALESCE(EXCLUDED.weight_scu,         uex_item.weight_scu)`,
        )
        .execute();
