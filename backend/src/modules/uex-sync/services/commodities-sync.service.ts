      ...
      await this.commodityRepository
        ...
        .onConflict(
          `("uex_id") DO UPDATE SET
            name              = EXCLUDED.name,
            id_category       = COALESCE(EXCLUDED.id_category,       uex_commodity.id_category),
            code              = COALESCE(EXCLUDED.code,              uex_commodity.code),
            kind              = COALESCE(EXCLUDED.kind,              uex_commodity.kind),
            section           = COALESCE(EXCLUDED.section,           uex_commodity.section),
            is_raw            = COALESCE(EXCLUDED.is_raw,            uex_commodity.is_raw),
            is_harvestable    = COALESCE(EXCLUDED.is_harvestable,    uex_commodity.is_harvestable),
            is_buyable        = COALESCE(EXCLUDED.is_buyable,        uex_commodity.is_buyable),
            is_sellable       = COALESCE(EXCLUDED.is_sellable,       uex_commodity.is_sellable),
            is_illegal        = COALESCE(EXCLUDED.is_illegal,        uex_commodity.is_illegal),
            is_fuel           = COALESCE(EXCLUDED.is_fuel,           uex_commodity.is_fuel),
            price_buy         = COALESCE(EXCLUDED.price_buy,         uex_commodity.price_buy),
            price_sell        = COALESCE(EXCLUDED.price_sell,        uex_commodity.price_sell),
            scu               = COALESCE(EXCLUDED.scu,               uex_commodity.scu),
            mass              = COALESCE(EXCLUDED.mass,              uex_commodity.mass),
            star_citizen_uuid = COALESCE(EXCLUDED.star_citizen_uuid, uex_commodity.star_citizen_uuid),
            active            = EXCLUDED.active,
            deleted           = EXCLUDED.deleted,
            modified_by       = EXCLUDED.modified_by,
            date_modified     = NOW(),
            uex_date_modified = COALESCE(EXCLUDED.uex_date_modified, uex_commodity.uex_date_modified)`,
        )
        .execute();
