...
| Rate limiting     | 10 requests per 60 seconds per IP (`AUTH_TOKEN_THROTTLE_TTL_MS` / `AUTH_TOKEN_THROTTLE_LIMIT`; hardcoded at these defaults in deployed environments — the release workflow does not write these vars) |
